...
export default function HomePage() {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Modliq is a manufacturing intelligence platform made in Tamil Nadu, India by Qeltrava AI. It helps factory teams turn production data into process decisions, validated quality, and buyer-ready Quality Passports.',
        },
      },
      {
        '@type': 'Question',
        name: 'Who is Modliq built for?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Modliq is built for factory owners, plant heads, quality managers, process engineers, operations managers, and supplier quality teams in chemical, food, pharma, automotive, textile, plastic, and precision manufacturing.',
        },
      },
      {
        '@type': 'Question',
        name: 'How does Modliq optimize process settings?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Modliq parses process goals, checks dataset health, trains machine learning models on historical plant data, predicts yield targets, and outputs safe parameter trial ranges and 7-batch trial SOPs.',
        },
      },
      {
        '@type': 'Question',
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-white text-[#1B2A4A] font-sans antialiased">
      ...
      {/* 2. Hero Section — Fully Responsive & Touch-Optimized */}
      ...
      {/* 3. Audience Section */}
      <section className="w-full py-12 sm:py-16 bg-white border-b border-[#D0E2F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div key={idx} className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-3 shadow-xs">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div key={idx} className="p-5 sm:p-6 bg-white border border-[#D0E2F0] rounded-2xl space-y-2 shadow-card">
                <span className="text-xs font-bold text-red-600 uppercase">Challenge 0{idx + 1}</span>
                <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">{prob.title}</h3>
      ...
      <section id="features" className="w-full py-16 sm:py-20 bg-white border-b border-[#D0E2F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {/* Group A */}
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-4">
              <div className="flex items-center gap-3 border-b border-[#D0E2F0] pb-3">
                <Database className="w-5 h-5 text-[#2B70AB] shrink-0" />
                <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">A. Data & Ingestion</h3>
              </div>
            ...
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-4">
              <div className="flex items-center gap-3 border-b border-[#D0E2F0] pb-3">
                ...
                <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">B. Dataset Health & Setup</h3>
              </div>
              <ul className="space-y-2 text-xs text-slate-700">
            ...
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-4">
              <div className="flex items-center gap-3 border-b border-[#D0E2F0] pb-3">
                ...
                <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">C. Process Optimization</h3>
              </div>
              <ul className="space-y-2 text-xs text-slate-700">
            ...
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-4">
              <div className="flex items-center gap-3 border-b border-[#D0E2F0] pb-3">
                ...
                <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">D. Quality Engineering</h3>
              </div>
              <ul className="space-y-2 text-xs text-slate-700">
            ...
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-4">
              <div className="flex items-center gap-3 border-b border-[#D0E2F0] pb-3">
                <BarChart3 className="w-5 h-5 text-[#1B2A4A] shrink-0" />
                <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">E. Operations / Supply / Lean</h3>
              </div>
              <ul className="space-y-2 text-xs text-slate-700">
            ...
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-4">
              <div className="flex items-center gap-3 border-b border-[#D0E2F0] pb-3">
                ...
                <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">F. Trust, AI & Reports</h3>
              </div>
              <ul className="space-y-2 text-xs text-slate-700">
      ...
      <section id="workflow" className="w-full py-16 sm:py-20 bg-[#F0F6FA] border-b border-[#D0E2F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
            {[
              ...
              <div key={idx} className="p-3.5 sm:p-4 bg-white border border-[#D0E2F0] rounded-xl sm:rounded-2xl space-y-2 shadow-xs">
      ...
      <section id="algorithms" className="w-full py-16 sm:py-20 bg-white border-b border-[#D0E2F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            <span className="text-xs font-bold text-[#2B70AB] uppercase tracking-wider">Engineering Methods</span>
            <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-[#1B2A4A]">Engineering methods under the hood.</h2>
            <p className="text-xs sm:text-sm text-slate-600">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-2">
              <span className="text-xs font-bold text-[#2B70AB] uppercase">Deterministic Math</span>
              <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">SPC, Cp/Cpk & OEE Calculations</h3>
            ...
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-2">
              ...
              <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">Surrogate Process Models</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-2">
              ...
              <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">AI-Assisted Interpretations</h3>
              <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="p-3.5 sm:p-4 bg-blue-50 border border-blue-200 rounded-xl sm:rounded-2xl text-center text-xs font-bold text-[#1B2A4A]">
      ...
      <section id="passport" className="w-full py-16 sm:py-20 bg-[#F0F6FA] border-b border-[#D0E2F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="space-y-4 sm:space-y-6">
              <span className="text-xs font-bold text-[#2B70AB] uppercase tracking-wider">Flagship Output</span>
              <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-[#1B2A4A]">The flagship output: Quality Passport.</h2>
              ...
              <div className="pt-2">
                <Link
                  href="/login"
                  className="w-full sm:w-auto min-h-[44px] px-6 py-3 bg-[#2B70AB] hover:bg-[#1B2A4A] text-white text-xs font-bold rounded-xl inline-flex items-center justify-center gap-2 transition text-center"
                >
                  <Award className="w-4 h-4 shrink-0" /> See Quality Passport →
                </Link>
              </div>
            </div>

            {/* Passport Mock Card */}
            <div className="p-5 sm:p-8 bg-white border border-[#D0E2F0] rounded-2xl sm:rounded-3xl shadow-card space-y-4 sm:space-y-6">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-[#D0E2F0] pb-4 gap-2">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#1B2A4A] text-white rounded-xl flex items-center justify-center font-bold shrink-0">
                    <Award className="w-5 h-5 text-amber-400" />
                  </div>
                  <div>
                    <span className="text-[10px] font-bold text-[#2B70AB] uppercase">Buyer-Ready Proof</span>
                    <h3 className="text-sm sm:text-base font-bold text-[#1B2A4A]">Quality Passport</h3>
                  </div>
                </div>
                <span className="px-2.5 py-1 bg-emerald-50 text-emerald-700 border border-emerald-200 text-xs font-bold rounded-full shrink-0">
      ...
      <section className="w-full py-16 sm:py-20 bg-white border-b border-[#D0E2F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="p-5 sm:p-6 bg-[#1B2A4A] text-white rounded-2xl space-y-2 border border-[#2B70AB] shadow-md">
      ...
      <section className="w-full py-16 sm:py-20 bg-[#F0F6FA] border-b border-[#D0E2F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            <span className="text-xs font-bold text-[#2B70AB] uppercase tracking-wider">Indian Manufacturing Reality</span>
            <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-[#1B2A4A]">Designed for Indian manufacturing realities.</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div key={idx} className="p-4 sm:p-5 bg-white border border-[#D0E2F0] rounded-2xl space-y-2 shadow-xs">
      ...
      <section className="w-full py-16 sm:py-20 bg-white border-b border-[#D0E2F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="bg-[#F0F6FA] border border-[#2B70AB]/30 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-card space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 border-b border-[#D0E2F0] pb-4 sm:pb-6">
              <div>
                <span className="text-xs font-bold text-[#2B70AB] uppercase tracking-wider">Limited Launch Pilot</span>
                <h2 className="text-xl sm:text-3xl font-bold text-[#1B2A4A] mt-0.5">
                  Free launch pilot for the first 10 selected manufacturing companies.
                </h2>
              </div>
              <span className="px-3 py-1 bg-amber-50 text-amber-700 border border-amber-200 text-xs font-bold rounded-full shrink-0">
                10 Slots Open
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              <div className="p-3.5 sm:p-4 bg-white rounded-xl border border-[#D0E2F0] text-xs space-y-1">
            ...
            <div className="pt-2 text-center sm:text-right">
              <Link
                ...
                className="w-full sm:w-auto min-h-[44px] px-6 py-3 bg-[#2B70AB] hover:bg-[#1B2A4A] text-white text-xs font-bold rounded-xl inline-flex items-center justify-center gap-2 transition text-center"
              >
                <Sparkles className="w-4 h-4 shrink-0" /> Apply for Free Pilot →
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className="w-full py-16 sm:py-20 bg-[#F0F6FA] border-b border-[#D0E2F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-10">
          <div className="bg-white border border-[#D0E2F0] rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-card flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8">
            <div className="space-y-3 w-full lg:max-w-lg">
              <span className="text-xs font-bold text-[#2B70AB] uppercase tracking-wider">Financial Impact</span>
              <h2 className="text-xl sm:text-3xl font-bold text-[#1B2A4A]">Estimate the value of better process decisions.</h2>
              <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="pt-2">
                <Link
                  ...
                  className="w-full sm:w-auto min-h-[44px] px-6 py-3 bg-[#2B70AB] hover:bg-[#1B2A4A] text-white text-xs font-bold rounded-xl inline-flex items-center justify-center gap-2 transition text-center"
                >
                  <TrendingUp className="w-4 h-4 shrink-0" /> Calculate Your Plant ROI →
                </Link>
              </div>
            </div>

            <div className="w-full lg:max-w-md p-4 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-xl sm:rounded-2xl space-y-3 text-xs">
      ...
      <section id="pricing" className="w-full py-16 sm:py-20 bg-white border-b border-[#D0E2F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-2 sm:space-y-3">
            <span className="text-xs font-bold text-[#2B70AB] uppercase tracking-wider">Pilot & Enterprise Plans</span>
            <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-[#1B2A4A]">Start with a pilot. Scale plant by plant.</h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border-2 border-[#2B70AB] rounded-2xl space-y-4 shadow-xl flex flex-col justify-between">
              <div className="space-y-2">
                ...
                <h3 className="text-base sm:text-lg font-bold text-[#1B2A4A]">Launch Pilot</h3>
                <p className="text-2xl sm:text-3xl font-extrabold text-[#2B70AB]">₹0</p>
            ...
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-4 shadow-card flex flex-col justify-between">
              <div className="space-y-2">
                <h3 className="text-base sm:text-lg font-bold text-[#1B2A4A]">Paid Pilot</h3>
                <p className="text-2xl sm:text-3xl font-extrabold text-[#1B2A4A]">₹99,000</p>
            ...
            <div className="p-5 sm:p-6 bg-[#F0F6FA] border border-[#D0E2F0] rounded-2xl space-y-4 shadow-card flex flex-col justify-between">
              <div className="space-y-2">
                <h3 className="text-base sm:text-lg font-bold text-[#1B2A4A]">Pro Plant</h3>
                <p className="text-2xl sm:text-3xl font-extrabold text-[#1B2A4A]">₹49,000 <span className="text-xs font-normal text-slate-500">/ mo</span></p>
            ...
            <div className="p-5 sm:p-6 bg-[#1B2A4A] text-white border border-[#1B2A4A] rounded-2xl space-y-4 shadow-xl flex flex-col justify-between">
              <div className="space-y-2">
                <h3 className="text-base sm:text-lg font-bold text-white">Enterprise</h3>
                <p className="text-2xl sm:text-3xl font-extrabold text-[#2B70AB]">Custom</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8">
          ...
          <div className="space-y-3">
            {jsonLdFaq.mainEntity.map((faq, idx) => (
              <div key={idx} className="p-4 sm:p-5 bg-white border border-[#D0E2F0] rounded-xl sm:rounded-2xl space-y-2 shadow-xs">
                <button
      ...
      {/* 15. Final CTA Banner */}
      <section className="w-full py-16 sm:py-20 bg-gradient-to-r from-[#1B2A4A] to-[#2B70AB] text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="pt-2 sm:pt-4 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full">
            <Link
              href="/contact?interest=free-pilot"
              className="w-full sm:w-auto min-h-[44px] px-8 py-3.5 bg-white text-[#1B2A4A] hover:bg-[#F0F6FA] text-xs sm:text-sm font-extrabold rounded-xl transition shadow-lg flex items-center justify-center text-center"
            >
              Apply for Free Pilot →
            </Link>
            <Link
              href="/login"
              className="w-full sm:w-auto min-h-[44px] px-8 py-3.5 bg-transparent border-2 border-white/80 hover:bg-white/10 text-white text-xs sm:text-sm font-bold rounded-xl transition flex items-center justify-center text-center"
            >
              Launch Demo
            </Link>
            <Link
              href="/contact"
              className="w-full sm:w-auto min-h-[44px] px-6 py-3.5 bg-white/10 hover:bg-white/20 text-white text-xs sm:text-sm font-semibold rounded-xl transition flex items-center justify-center text-center"
            >
              Contact Us
            </Link>
          </div>
