...
export const metadata: Metadata = {
  ...
  description:
    'Modliqer is a no-code manufacturing intelligence and machine learning platform by Qeltrava AI, built in Tamil Nadu, India. It helps factory teams upload data, run ML optimization, validate quality, track operations, and generate buyer-ready Quality Passports.',
  keywords: [
